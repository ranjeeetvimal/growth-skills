...
description: >
  Programmatic SEO at scale: template engineering, data sources, quality gates, and thin-content /index-bloat prevention. Use when the user asks about programmatic SEO, scaled pages, or template-driven content.
license: MIT
metadata:
...
TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Execution — Advanced.

## Reference library (read on demand)
- `references/programmatic-seo.md` — TODO: what this reference covers.
