...
description: >
  SEO content end to end — what to publish AND how to write it: topical clusters, pillar pages, a 90-day calendar and refresh cadence, plus answer-first structure, featured-snippet engineering, E-E-A-T, and conversion CTAs. Use when the user asks about SEO content, topical clusters, a content calendar, writing that ranks, or featured snippets.
license: MIT
metadata:
  author: Ranjeet Vimal
  version: "1.0.0"
  category: content
  related-skills: seo-context, seo-strategy, seo-analytics
---

# Content Strategy SEO

TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Execution — On-page.

## Reference library (read on demand)
- `references/content-strategy-seo.md` — TODO: what this reference covers.
