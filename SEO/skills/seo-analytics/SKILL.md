...
name: seo-analytics
description: >
  SEO measurement as validation, not vanity: a revenue-tied North Star, leading vs lagging indicators, AI-visibility tracking, and traffic-drop alerts. Every metric answers 'what decision does this inform?' Use when the user asks about SEO metrics, reporting, attribution, or ROI.
license: MIT
metadata:
  author: Ranjeet Vimal
  version: "1.0.0"
  category: analytics
  related-skills: seo-context, seo-strategy
---

# SEO Analytics

TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Measurement.

## Reference library (read on demand)
- `references/metrics-seo.md` — TODO: what this reference covers.
