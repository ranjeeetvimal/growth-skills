...
description: >
  Technical SEO audit AND site architecture: indexability, Core Web Vitals (LCP/INP/CLS), JavaScript rendering and AI-crawler visibility (GPTBot/ClaudeBot/PerplexityBot don't render JS), plus URL structure, internal linking, and click depth. Use when the user asks about technical SEO, crawlability, Core Web Vitals, site structure, or internal linking.
license: MIT
metadata:
...
TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Audit.

## Reference library (read on demand)
- `references/technical-audit.md` — TODO: what this reference covers.
