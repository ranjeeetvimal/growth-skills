...
name: link-building
description: >
  Earns links without spam: linkable assets, broken-link opportunities, digital PR angles, and competitor-backlink replication. Use when the user asks about link building, backlinks, digital PR, or domain authority.
license: MIT
metadata:
...
TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Execution — Off-page.

## Reference library (read on demand)
- `references/link-building.md` — TODO: what this reference covers.
