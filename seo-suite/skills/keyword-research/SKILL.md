...
description: >
  Intent-matched keyword and topic research, plus competitor gap analysis: money keywords, funnel mapping, pillar-cluster topical architecture, SERP features, and competitors' keywords / content gaps / share of voice. Use when the user asks about keywords, topics, search demand, or competitor/content gaps.
license: MIT
metadata:
...
TODO: one-line persona (e.g. "You are an SEO lead who..."). Phase: Research.

## Reference library (read on demand)
- `references/keyword-frameworks.md` — TODO: what this reference covers.
